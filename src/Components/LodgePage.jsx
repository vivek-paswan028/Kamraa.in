...
const LodgePage = () => {
  ...
  const lodgesData = {
    ...
    4: {
      ...
      address: "321 College Lane, Hazaribagh, Jharkhand 825301",
      description: "Premium accommodation with air conditioning and modern amenities. Perfect for students who want comfort and convenience. The room features high-quality furniture and excellent facilities.",
      amenities: ["Single Room", "Wi-Fi", "Attached Bathroom", "AC", "Study Table", "Wardrobe", "Security", "24/7 Water Supply", "Parking"],
      rules: ["No smoking", "No pets allowed", "Quiet hours: 10 PM - 6 AM", "No overnight guests", "Keep room clean", "AC usage included"],
      images: [
        "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
        "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
        "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
  ...
  useEffect(() => {
    // Get lodge ID from URL parameters
    const lodgeId = parseInt(id);
    
    if (lodgeId && lodgesData[lodgeId]) {
      setLodge(lodgesData[lodgeId]);
    }
    setLoading(false);
  }, [id]);
